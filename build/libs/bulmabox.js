//This is my own library that I (David Newman) wrote a while ago as sister to Bootstrap's Bootbox modal library. It's just to make prettier alerts and stuff!
...
bulmabox.confirm = function (a, b, c) {
    ...
    var btns = '<button class=\'button col-style-one-hoverable\' onclick=\'bulmabox.runCb(bulmabox.params.cb,true)\'>Okay</button><button class=\'button col-style-two-hoverable\' onclick=\'bulmabox.runCb(bulmabox.params.cb,false)\'>Cancel</button>';
    bulmabox.dialog(bulmabox.params.tt, bulmabox.params.ms, btns);
};
...
bulmabox.prompt = function (a, b, c) {
    ...
    var btns = '<button class=\'button col-style-one-hoverable\' onclick=\'bulmabox.runCb(bulmabox.params.cb,document.querySelector("#bulmabox-diag-txt").value)\'>Okay</button><button class=\'button col-style-two-hoverable\' onclick=\'bulmabox.runCb(bulmabox.params.cb,false)\'>Cancel</button>';
    bulmabox.dialog(bulmabox.params.tt, bulmabox.params.ms, btns);
};
