...
gulp.task('sass', function() {
    return gulp.src('build/scss/*.scss')
        .pipe(sass())
        // .pipe(addSrc.prepend('build/scss/components/school-vars.css'))
        .pipe(concat('styles.css'))
        .pipe(cleany())
        .pipe(gulp.dest('public/css'));
});
gulp.task('cssVars', function() {
    return gulp.src('/build/scss/components/school-vars.css')
        .pipe(gulp.dest('public/css'))
})
...
gulp.task('watch', function() {
    ...
    gulp.watch(['build/scss/*.scss', 'build/scss/**/*.scss'], ['sass', 'cssVars']);
});

//no watchin!
gulp.task('render', ['lint', 'sass', 'cssVars', 'scripts'])

// Default Task
gulp.task('default', ['lint', 'sass', 'cssVars', 'scripts', 'checkDB', 'watch']);